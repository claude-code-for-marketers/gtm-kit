...
That's it. Claude will read your ICP, signals, and competitor context automatically and produce a structured research brief. Outputs land in `outputs/` using the `YYYY-MM-DD-research-[account].md` naming convention.
